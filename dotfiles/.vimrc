...
fun SetupVAM()
    ...
    call vam#ActivateAddons(["github:ervandew/supertab", "matchit.zip", "vim-less", "delimitMate", "Indent_Guides", "jQuery", "tComment", "IndexedSearch", "github:Glench/Vim-Jinja2-Syntax", "JavaScript_Indent", "github:briandoll/change-inside-surroundings.vim", "ctrlp", "github:scrooloose/syntastic", "easytags"], {'auto_install' : 0})
...
" Easytags, jump to classes/functions
    " https://github.com/xolox/vim-easytags
    " NOTE: need to install exuberant-ctags for this to work
    " option to work with indexedsearch
